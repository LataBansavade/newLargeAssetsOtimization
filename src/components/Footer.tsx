...
const Footer = () => {
  ...
  return (
    <footer className=" text-white  pt-20 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold">VideoHub</h3>
            <p className="text-gray-400">Your premier destination for high-quality video content and streaming experiences.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Nature</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Wildlife</a></li>
